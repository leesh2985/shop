  ...
  return (
    <footer className={styles.footerContainer}>
      <div className={styles.linkGrid}>
        <a href="https://zero-base.co.kr/" target="_blank" className={styles.link}>
          제로베이스
        </a>
      </div>
      ...
      <div>
        <ul className={styles.iconContainer}>
          <li className={styles.iconItem}>
            <a href="https://www.facebook.com/0base" className={styles.iconLink} target="_blank" data-tip="facebook">
              <svg
                xmlns="http://www.w3.org/2000/svg"
      ...
      <div>
        <p className={styles.copy}>Copyright © 2022 Zero Base</p>
      </div>
    </footer>
  );
}
